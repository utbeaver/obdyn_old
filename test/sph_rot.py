...
b1mar1=OdMarker(4, V3(0, 1, 0), V3(), "b1I") 
b[1].add_marker(b1mar1)
b1mar23=OdMarker(5, V3(0, -1, 0), V3(), "b2_3") 
...
cm2 = OdMarker(6, V3(c45*3, -s45*3, 0), V3(d45, 0, 0), "cm1")
b[2].add_cm_marker(cm2)
b2mar1=OdMarker(7, V3(0, 0, 0), V3(), "b2I") 
...
for i in range(9000):
    ...
    types=["time"]
    if hht==1:
        sys_.dynamic_analysis_hht(t_, 1.0e-5, 10, 0.001, 1.0e-6, 1.0e-3, 1)
    else:    
