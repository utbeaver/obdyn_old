...
#ground
ground = OdBody(0)
mar1 = OdMarker(1, zeros, zeros)
mar2 = OdMarker(2, zeros, zeros)
marfrom7 = OdMarker(77, zeros, zeros)
ground.add_marker(mar1)
ground.add_marker(mar2)
ground.add_marker(marfrom7)
#body 1
b1 = OdBody(1)
mar3 = OdMarker(3, zeros, zeros)
mar4 = OdMarker(4, zeros, zeros)
mar1to4 =OdMarker(20, zeros, zeros)
b1_cm = OdMarker(5, zeros, zeros)
b1.add_marker(mar3)
b1.add_marker(mar4)
...
#body 2
b2 = OdBody(2)
m6 = OdMarker(6, zeros, zeros)
m7 = OdMarker(7, zeros, zeros)
marfrom6 = OdMarker(26, zeros, zeros)
b2_cm = OdMarker(18, zeros, zeros)
b2.add_marker(m6)
b2.add_marker(m7)
...
#body 3
b3 = OdBody(3)
m8 = OdMarker(8, zeros, zeros)
m81 = OdMarker(81, zeros, zeros)
m9 = OdMarker(9, zeros, zeros)
b3_cm = OdMarker(10, zeros, zeros)
b3.add_marker(m8)
b3.add_marker(m81)
b3.add_marker(m9)
...
#body 4
b4 = OdBody(4)
m11 = OdMarker(11, zeros, zeros)
m12 = OdMarker(12, zeros, zeros)
b4_cm = OdMarker(99, zeros, zeros)
b4.add_marker(m11)
b4.add_marker(m12)
...
#body 5
b5 = OdBody(5)
m13 = OdMarker(13, zeros, zeros)
m14 = OdMarker(14, zeros, zeros)
b5_cm = OdMarker(19, zeros, zeros)
b5.add_marker(m13)
b5.add_marker(m14)
...
#body 6
b6 = OdBody(6)
m15 = OdMarker(15, zeros, zeros)
m16 = OdMarker(16, zeros, zeros)
b6_cm = OdMarker(17, zeros, zeros)
b6.add_marker(m15)
b6.add_marker(m16)
...
for i in range(4):
    b.append(OdBody(i+1))
    cm.append(OdMarker(i+10, zeros, zeros))
    b[i].add_cm_marker(cm[i])
for i in range(3):
    marj.append(OdMarker(i, zeros, zeros))
...
for i in range(3):
    ...
    b[i].add_marker(marj[i])
for i in range(3):
    mari.append(OdMarker(i+3), zeros, zeros)
    b[1+i].add_marker(mari[i])
marjonb4 = OdMarker(20, zeros, zeros)
marionb1 = OdMarker(21, zeros, zeros)
...
for i in range(8):
    b.append(OdBody(i))
    mari.append(OdMarker(i+10), zeros, zeros)
    b[i].add_marker(mari[i])
    marj.append(OdMarker(i+20), zeros, zeros)
    b[i].add_marker(marj[i])
    if i != 0:
        marc.append(OdMarker(i+1), zeros, zeros)
...
for i in range(11):
    b.append(OdBody(i))
    mari.append(OdMarker(i+20), zeros, zeros)
    b[i].add_marker(mari[i])
    marj.append(OdMarker(i+40), zeros, zeros)
    b[i].add_marker(marj[i])
    if i != 0:
        marc.append(OdMarker(i+1), zeros, zeros)
        b[i].add_cm_marker(marc[i-1])
...
for i in range(14):
    b.append(OdBody(i))
for i in range(18):
    mari.append(OdMarker(i), zeros, zeros)
    marj.append(OdMarker(i+18), zeros, zeros)
for i in range(14):
    if i != 0:
    	marc.append(OdMarker(100+i), zeros, zeros)
	b[i].add_cm_marker(marc[i-1])
for i in range(6):
...
cm1 = OdMarker(1, [0.0, 0.5, 0.0], [0.0, 0.0, 0.0])
